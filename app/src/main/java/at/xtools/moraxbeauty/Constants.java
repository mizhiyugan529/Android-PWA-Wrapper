...
public class Constants {
    public Constants(){}
    // Root page
    public static String WEBAPP_URL = "https://morax.beauty/";
    public static String WEBAPP_HOST = "morax.beauty"; // used for checking Intent-URLs
    ...
    public static String USER_AGENT_POSTFIX = "MoraxBeautyAndroid"; // useful for identifying traffic, e.g. in Google Analytics
